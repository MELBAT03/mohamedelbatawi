...
#define GPIO_PORT0 (MCAL_GPIO_PORT0)
#define GPIO_PORT1 (MCAL_GPIO_PORT1)
#define GPIO_PORT2 (MCAL_GPIO_PORT2)
#define GPIO_PORT3 (MCAL_GPIO_PORT3)
#define GPIO_PORT4 (MCAL_GPIO_PORT4)
#define GPIO_PORT5 (MCAL_GPIO_PORT5)
