...
typedef struct
{
  ...
  __IO uint32_t TPWM0;             /*!< 0PWM period rate (PWM period [s] * maximum speed * 2^16)*/
  __IO uint32_t OMEGA0;            /*!< Rotation speed (speed [Hz]/ maximum speed * 2^15)*/
  __IO uint32_t THETA0;            /*!< Motor phase (motor phase [deg]/360 * 2^16)   */
  __IO uint32_t IDREF0;            /*!< d-axis reference value (current [A] / maximum current * 2^15)*/
  __IO uint32_t IQREF0;            /*!< q-axis reference value (current [A] / maximum current * 2^15)*/
  __IO uint32_t VD0;               /*!< d-axis voltage (voltage [V] / maximum voltage * 2^31)*/
  __IO uint32_t VQ0;               /*!< q-axis voltage (voltage [V] / maximum voltage * 2^31)*/
  ...
  __IO uint32_t IAO0;              /*!< AD conversion result of a-phase zero-current */
  __IO uint32_t IBO0;              /*!< AD conversion result of b-phase zero-current */
  __IO uint32_t ICO0;              /*!< AD conversion result of c-phase zero-current */
  __IO uint32_t IAADC0;            /*!< AD conversion result of a-phase current      */
  __IO uint32_t IBADC0;            /*!< AD conversion result of b-phase current      */
  __IO uint32_t ICADC0;            /*!< AD conversion result of c-phase current      */
  __IO uint32_t VDC0;              /*!< DC supply voltage (voltage [V] / maximum voltage * 2^15) */
  __IO uint32_t ID0;               /*!< d-axis current (current [A] / maximum current * 2^31)*/
  __IO uint32_t IQ0;               /*!< q-axis current (current [A] / maximum current * 2^31)*/
  __IO uint32_t MCTLF1;            /*!< Status flags                                 */
  __IO uint32_t MODE1;             /*!< Task control mode                            */
  __IO uint32_t FMODE1;            /*!< Flow control                                 */
  __IO uint32_t TPWM1;             /*!< 0PWM period rate (PWM period [s] * maximum speed * 2^16)*/
  __IO uint32_t OMEGA1;            /*!< Rotation speed (speed [Hz]/ maximum speed * 2^15)*/
  __IO uint32_t THETA1;            /*!< Motor phase (motor phase [deg]/360 * 2^16)   */
  __IO uint32_t IDREF1;            /*!< d-axis reference value (current [A] / maximum current * 2^15)*/
  __IO uint32_t IQREF1;            /*!< q-axis reference value (current [A] / maximum current * 2^15)*/
  __IO uint32_t VD1;               /*!< d-axis voltage (voltage [V] / maximum voltage * 2^31)*/
  __IO uint32_t VQ1;               /*!< q-axis voltage (voltage [V] / maximum voltage * 2^31)*/
  ...
  __IO uint32_t IAO1;              /*!< AD conversion result of a-phase zero-current */
  __IO uint32_t IBO1;              /*!< AD conversion result of b-phase zero-current */
  __IO uint32_t ICO1;              /*!< AD conversion result of c-phase zero-current */
  __IO uint32_t IAADC1;            /*!< AD conversion result of a-phase current      */
  __IO uint32_t IBADC1;            /*!< AD conversion result of b-phase current      */
  __IO uint32_t ICADC1;            /*!< AD conversion result of c-phase current      */
  __IO uint32_t VDC1;              /*!< DC supply voltage (voltage [V] / maximum voltage * 2^15)*/
  __IO uint32_t ID1;               /*!< d-axis current (current [A] / maximum current * 2^31)*/
  __IO uint32_t IQ1;               /*!< q-axis current (current [A] / maximum current * 2^31)*/
       uint32_t RESERVED3;
...
#define TSB_SC2_MOD1_I2S0                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_SC2->MOD1,7)))
...
#define TSB_SC3_MOD1_I2S0                         (*((__IO uint32_t *)BITBAND_PERI(&TSB_SC3->MOD1,7)))
...
#define TSB_ADA_MOD0_DACON                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_ADA->MOD0,1)))
...
#define TSB_ADB_MOD0_DACON                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_ADB->MOD0,1)))
