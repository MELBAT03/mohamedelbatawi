...
#ifndef __TMPM370_ENC_H
#define __TMPM370_ENC_H
...
#define EN0    TSB_EN0
#define EN1    TSB_EN1
#define IS_ENC_PERIPH(param)          (((param) == EN0) || ((param) == EN1))
...
#define ENC_NO_FILTER                 ((uint32_t)0x00000000)    /* No filtering */
#define ENC_FILTER_VALUE31            ((uint32_t)0x00000001)    /* Filters out pulses narrower than 31/fsys as noise */
#define ENC_FILTER_VALUE63            ((uint32_t)0x00000002)    /* Filters out pulses narrower than 63/fsys as noise */
#define ENC_FILTER_VALUE127           ((uint32_t)0x00000003)    /* Filters out pulses narrower than 127/fsys as noise */
