    ...
    _M_handle_match(_Match_mode __match_mode, _StateIdT __i)
{
    ...
    else if (__state._M_matches(*_M_current))
...
struct _Backref_matcher
{
    ...
    {
        return _M_traits.transform(__expected_begin, __expected_end) == _M_traits.transform(__actual_begin, __actual_end);
    }
...
struct _Backref_matcher<_BiIter, std::regex_traits<_CharT>>
{
             ...
             _BiIter __actual_end)
    {
        ...
        return _GLIBCXX_STD_A::__equal4(__expected_begin, __expected_end,
                                        ...
                                        {
                                            return __fctyp.tolower(__lhs) == __fctyp.tolower(__rhs);
                                        });
    }
    ...
    _M_handle_accept(_Match_mode __match_mode, _StateIdT __i)
{
    if (__dfs_mode)
    {
        ...
        if (__match_mode == _Match_mode::_Exact)
            ...
            _M_has_sol = true;
        if (_M_current == _M_begin && (_M_flags & regex_constants::match_not_null))
            _M_has_sol = false;
        if (_M_has_sol)
        {
            ...
            else   // POSIX
            {
                ...
                if (*_M_states._M_get_sol_pos() == _BiIter() || std::distance(_M_begin,
                                                                              *_M_states._M_get_sol_pos()) < std::distance(_M_begin, _M_current))
                {
    ...
    _M_dfs(_Match_mode __match_mode, _StateIdT __i)
{
    ...
    switch (_M_nfa[__i]._M_opcode())
    {
        case _S_opcode_repeat:
            _M_handle_repeat(__match_mode, __i);
            break;
        case _S_opcode_subexpr_begin:
            _M_handle_subexpr_begin(__match_mode, __i);
            break;
        case _S_opcode_subexpr_end:
            _M_handle_subexpr_end(__match_mode, __i);
            break;
        case _S_opcode_line_begin_assertion:
            _M_handle_line_begin_assertion(__match_mode, __i);
            break;
        case _S_opcode_line_end_assertion:
            _M_handle_line_end_assertion(__match_mode, __i);
            break;
        case _S_opcode_word_boundary:
            _M_handle_word_boundary(__match_mode, __i);
            break;
        case _S_opcode_subexpr_lookahead:
            _M_handle_subexpr_lookahead(__match_mode, __i);
            break;
        case _S_opcode_match:
            _M_handle_match(__match_mode, __i);
            break;
        case _S_opcode_backref:
            _M_handle_backref(__match_mode, __i);
            break;
        case _S_opcode_accept:
            _M_handle_accept(__match_mode, __i);
            break;
        case _S_opcode_alternative:
            _M_handle_alternative(__match_mode, __i);
            break;
        default:
    ...
    _M_word_boundary() const
{
    ...
    if (_M_current != _M_begin || (_M_flags & regex_constants::match_prev_avail))
    {
