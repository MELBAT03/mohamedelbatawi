...
template <>
void __timepunct<char>::_M_put(char *, size_t, const char *, const tm *) const throw();
...
#if defined _GLIBCXX_LONG_DOUBLE_COMPAT && defined __LONG_DOUBLE_128__ && _GLIBCXX_USE_CXX11_ABI == 0
    virtual iter_type
