...
template <class _InputIterator, class _DifferenceType, class _OutputIterator, class _Assigner>
void __simd_copy_by_mask(_InputIterator __first, _DifferenceType __n, _OutputIterator __result, bool *__mask,
...
void __simd_partition_by_mask(_InputIterator __first, _DifferenceType __n, _OutputIterator1 __out_true,
...
struct _Combiner
{
    ...
    _Combiner(const _Combiner &__obj)
        : __value{}, __bin_op(__obj.__bin_op)
    {
    }
            ...
            _BinaryOperation __binary_op, /*Inclusive*/ std::false_type)
{
    ...
    __PSTL_PRAGMA_SIMD_SCAN(__bin_op
                            : __init_)
    for (_Size __i = 0; __i < __n; ++__i)
    {
...
__simd_min_element(_ForwardIterator __first, _Size __n, _Compare __comp) noexcept
{
    ...
    struct _ComplexType
    {
        ...
        _ComplexType()
            : __min_val{}, __min_ind{}, __min_comp(nullptr)
        {
        }
    ...
    __PSTL_PRAGMA_SIMD_REDUCTION(__min_func
                                 : __init)
